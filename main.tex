...
C'est la dernière révolution du 19\up{e} siècle.
Elle préfigure les révolutions du 20\up{e} siècle, qui sont des révolutions idéologiques.\footnote{Ce sont des révolutions idéologiques, et pas simplement libérales et/ou nationales, comme les révolutions du 19\up{e} siècle. Pour rappel, 1820 a échoué, 1830 est un mouvement national, 1848 est un mouvement national et social.}
...
Le 19\up{e} siècle connaît deux révolutions industrielles, la première de 1815 à 1871, et la deuxième de 1971 à 1914.
...
La révolution industrielle a commencé en Angleterre au début du 19\up{e} siècle et s’est
...
ainsi des capitaux importants et on partage les risques. À partir du milieu du 19\up{e} 
siècle, ce système se répand dans toutes l’Europe. Il était déjà présent à la fin du 18\up{e} 
siècle en Angleterre (milieu du 18\up{e} pour le reste). Les banques nationales commencent
...
au 19\up{e} siècle. Quand on regarde les maisons bourgeoises du 19\up{e} siècle, elles ne sont pas au
...
sont des enfants qu’il faut guider (la figure de l’enfant n’est pas particulièrement bonne au 19\up{e} 
siècle\footnote{Au 19\up{e} siècle, on considère que les enfants ont une nature mauvaise.}).
...
Au 19\up{e} siècle on est de plus en plus sensible à la violence (on la supporte de moins en
moins). Cette sensibilité accrue se voit dans des choses concrètes comme la peine de mort :

\begin{itemize}
	\item Au début du 19\up{e} à Bruxelles, les exécutions capitales étaient effectuées sur la grande
place à midi.
...
Tanguy a tué sa sœur mais tout le monde s’en fiche. Au 19\up{e} siècle, on est assassin à vie et
c’est encore le cas aujourd’hui. Il y a un recul de la violence physique au 19\up{e} et une
...
Dans l’inconscient du 19\up{e} siècle (et encore aujourd’hui ?) la pauvreté est une faute sociale.
...
\begin{itemize}
	...
	\item Au 19\up{e} siècle, qui concerne principalement l'Afrique. On en connaissait alors juste les contours.
\end{itemize}
...
colonisations de la fin du 19\up{e} siècle.
...
Il y a deux visions du nationalisme : la conception germanique et la conception latine. Les
deux ont tords. Qu’est-ce qu’une nation ? Une nation c’est une communauté imaginée
pérennisée par des institutions. Il existe, en parallèle, d’autres visions toujours intégrées dans
les mentalités.

\section{La conception germanique}

C’est une vision \emph{essentialiste} avec une origine inconsciente de la nation.

La nation est un organisme vivant et autonome qui se développe grâce à une force supérieure :
le génie et l’âme nationale. Le darwinisme social va être à l’aise dans ce type de notion. Il y a
donc une série d’évènements externes faciles à reconnaitre et communs aux membres de la
nation. Il s’agit des traditions, des coutumes, de la langue et de la «~race~». La «~race~» au
19 ème siècle ne doit pas être chargée des conceptions du 20 ème siècle. De tous ces critères, c’est
très souvent la langue qui prime.

La première formulation systématique de cette vision essentialise vient de Johann Gottlieb
Fichte qui au lendemain de la défaite d’Iéna prononce son «~discours à la nation allemande~».
Il veut déclencher un sursaut des Prussiens face aux Français. Ce n’est pas encore un
nationalisme intégral mais il s’emploie à décrire la germanité. Pour lui, le fin fond de l’âme
germanique c’est la langue. Il parle de la langue allemande comme d’une «~langue des
origines~». Les nationalistes de type essentialiste sont souvent obsédés par la pureté des
origines. Ce n’est pas le cas des langues romanes qui ne sont que des dérivés du latin ou pire
de l’anglais qui est une langue hybride. Scientifiquement ça ne tient pas car le mélange fait du
bien. De cette scientificité douteuse, la conception essentialiste de la nation tire deux
conséquences :

\begin{itemize}
\item Quand les populations possèdent ces caractéristiques communes, on peut affirmer
qu’elles appartiennent à la nation même si elles n’en n’ont pas conscience. Ce sont les
«~Allemands qui s’ignorent~». Les pangermanistes de la fin du 19 ème et du début 20 ème
siècle vont exploiter ça dans des pensées expansionniste avec le greffage d’une
idéologie darwiniste sociale.
\item Cette conception essentialiste se fond bien avec un régime conservateur favorisant le
système autoritaire voir dictatorial.
\end{itemize}

\section{La conception latine}

C’est une conception \emph{élective}.

Elle part de l’inverse de la conception germanique : l’appartenance à une nation est un fait de
conscience. Les tenants de cette conception ne nient pas que la langue, la tradition, etc.,
peuvent être des facteurs importants mais ils ne sont ni nécessaires ni suffisants. L’élément
essentiel c’est la volonté de vivre en commun. La conséquence de cette conception élective de
la nation est que la population peut s’exprimer librement pour faire part de son sentiment ou
non d’appartenance à la nation. La conception élective va donc de pair avec un régime
démocratique. Précisons que cette conception ne tient pas non plus la route.

Il est intéressant de lire la correspondance entre deux historiens français et allemands : Fustel
de Coulanges et Theodor Mommsen. Ils s’expriment tous les deux à propos de l’Alsace.
Mommsen dit que l’Alsace est allemande et déploie sa thèse essentialiste. Fustel lui rétorque :
«~les Alsaciens ne veulent pas faire partie de l’Allemagne~» et dépolit sa vision élective. Les
deux conceptions nationalistes s’opposent au niveau de l’Alsace.

Au cours du 19 ème siècle s’effectue une intériorisation de cette conception dans l’identité
nationale.

\section{Une évolution complexe : le culte de la Patrie}

La dualité originelle du nationalisme explique sa complexité au 19\up{e} puis au 20\up{e} siècle et
l’ambivalence des phénomènes qui relèvent de ces nationalismes. L’histoire du 19\up{e} siècle
tient dans la dualité entre ces nationalismes de droite et de gauche. Dans les années 1830-1840, acquérir les idées de liberté et de nation se confondent. Les constitutions s’opposent aux
monarchies absolues. Les patriotes nationalistes veulent s’affranchir d’une nation étrangère.
C’est le cas de la Belgique et de l’Italie. Le nationalisme et le libéralisme se confondent.

Entre 1830 et 1850, nationalisme et démocratie se mélangent mais échouent en 1848 avec la
deuxième restauration. Le nationalisme renait de ses centres à la troisième vague
révolutionnaire de 1850-1870. Si à ce niveau les mouvements nationalistes prennent encore
appui sur le peuple c’est parfois au détriment de la liberté. C’est le cas de l’unification
allemande et italienne qui compte plus sur la guerre, la diplomatie et les alliances extérieures
que sur le peuple.

À la fin du 19 ème siècle (1870-1900), il y a une dernière transformation du nationalisme d’un
mouvement de gauche libérale et démocratique vers un mouvement de droite d’inspiration
conservatrice et imprégné de darwinisme social.

Le cas de la France est typique. Au lendemain de défaite 1871, le nationalisme français,
blessé et meurtri, devient xénophobe et réactionnaire. Il avait démarré à gauche puis bascule
finalement au début du 20 ème siècle vers la droite. Au début de ce siècle, les nationalismes
sont exacerbés. On considère que le culte de la patrie est un droit qui prime sur tout. Ce
nationalisme peut être défensif ou offensif. Les nationalismes allemand et russe sont offensifs
(pangermanisme et panslavisme). Les nationalismes français et britannique sont plutôt
défensifs.

\chapter{La Première Guerre mondiale}

Jamais la première guerre n’a paru aussi proche et aussi lointaine. C’est un monde qui a
aujourd’hui disparu. Avec la communauté européenne, il est presque impossible de penser les
affrontements du 20 ème siècle. La Première guerre mondiale reste tout de même proche avec
les démonstrations de violence de la fin du siècle (de Sarajevo à Sarajevo) que les spécialistes
de la Seconde guerre mondiale avaient du mal à expliquer et que les spécialistes de la
Première n’avaient aucun mal à expliquer. On pense aux pratiques de viol de guerre pour salir
la race adverse, etc.

\section*{Introduction (débats historiographiques)}

Depuis une vingtaine d’années, l’historiographie de la Première guerre mondiale s’est
renouvelée. Avant, on se posait la grande question, dès les années 20, du démarrage de la
guerre en relation avec les réparations et les «~la fautes à qui ?~». Ce débat s’est déplacé mais
n’est pas encore fini.

L’historien australien Christopher Clarke dédouane largement les pays centraux. Il met en
évidence la géopolitique extrêmement complexe de 1911-1914 et la peur, pas tout à fait
fantasmée, de l’Allemagne prise en étaux avec une France germanophobe et une Russie qui
renforce ses armées. Elle sait que si elle est la plus forte armée du monde en 1914, elle ne le
sera plus en 1917. Face à un conflit apparemment inévitable, le plus tôt serait le mieux. Qui
va contrer l’ouvrage de Clarke qui a d’ailleurs eu un énorme succès en Allemagne ? Gerd
Krumeich, un Allemand. Pour Krumeich, la responsabilité du lancement de la guerre réside
bien en Allemagne, pays qui a poussé sur le bouton.

Cependant, une des grandes questions qui anime la recherche depuis vingt ans est de constater
que dans l’entrée en guerre, si les responsabilités sont partagées, si les diplomates se sont
sentis dépassés par une mécanique automatique, les gouvernements du début du 20 ème siècle
ont été soutenus par l’opinion publique. Il y avait bien un consentement à la guerre et aux
violences qui en découle. Certains disent que la Première guerre mondiale était absurde, que
les soldats ont été forcé à se battre, etc. La grande question est bien de se dire : comment ont-ils 
tenu dans de telles conditions pendant aussi longtemps ?

Les tenants du pacifisme disent qu’ils ont tenu parce qu’ils étaient obligés et qui, s’ils ne
tenaient pas, étaient fusillés. Il est pourtant impossible de tenir pendant aussi longtemps une
armée qui se bat uniquement par la contrainte. Il n’y a donc pas que de la contrainte, il y a
aussi un consentement. Consentement ne veut bien sûr pas dire euphorie et il y a des
évolutions dans le consentement. En 1917 on est dans le consentement le plus bas mais qui
tient partout sauf en Russie. Il existe en fait différentes formes de consentement. Il peut y
avoir un consentement fort mais aussi un consentement «~je dois le faire par devoir~». C’est un
«~consentement de payer l’impôt~» : on se plaint, on trouve ça trop ou injuste, mais on le fait
quand même. Il faut donc nuancer ce mot mais en partant de ce principe, cela rend 14-18
encore plus mystérieux. Les populations auraient donc bien consentis à ce bain de sang. De
quoi est fait ce consentement ? Se fait-il selon la classe social ou la position dans la guerre
(front, arrière, champ, usine, homme, femme, etc.) ?

Une autre grande question qui anime l’historiographie aujourd’hui, est l’idée de 14-18 comme
genèse de l’horreur du 20 ème siècle. Il faut analyser les pratiques de violences. On parle
toujours de boucherie, des millions de mort, etc. Au final, tout le monde meurt mais personne
ne tue. Il est vrai que l’artillerie, très importante durant la Première guerre, tue à distance mais
il y a aussi eu beaucoup de corps à corps. Les nettoyeurs de tranchée sont tous volontaires. Ils
ont seulement des poignards, des casses têtes, etc. Il y aura aussi les pratiques de violences à
l’encontre des civils : les atrocités allemandes. Il y a aussi le lien entre le monde des tranchées
et le monde de l’arrière. C’est un lien qu’on met de plus en plus en évidence. On peut faire
une histoire économique (la production) et une histoire des familles. Des millions de lettres
sont envoyées par jour du front vers l’arrière et de l’arrière vers le front. On voit que les
soldats continuent à jouer par la correspondance leur rôle de père et de mari. On associe par la
lettre le père à la vie de famille. On s’intéresse aussi à l’histoire des occupations qui intéresse
bien sur beaucoup la population aujourd’hui. Ces pratiques de violences contre les pays ne
seront connues par beaucoup de pays que lors de la Deuxième guerre. Ces pays subiront la
déportation, la faim, la clandestinité, la collaboration, le compromis, la répression.
L’historiographie se déploie à ce niveau. Du coté belge on a une longue tradition de recherche
sur l’occupation (Henry Hague, Pirenne, etc.). On sait pas mal de chose sur les systèmes
d’occupations. On peut aussi s’intéresser au traumatisme de guerre.

Enfin, beaucoup d’études se font sur le «~retour des femmes aux foyers~» dans les années
1920. Elles ne disent peut-être rien mais elles se sont émancipées «~de force~». Il est aussi
intéressant de constater que beaucoup d’hommes célibataires de retour de front
s’accommoderont plus facilement de ces femmes qui ont appris à être plus indépendantes. Ces
hommes fatigués seront plus prêt à laisser leur femme prendre des initiatives. Il y a aussi une
réflexion sur le bonheur en considérant que le malheur s’imprime de manière plus forte dans
les sources.

\subsection{Les entrées en guerre}

On a longtemps dit que les combattants étaient partis la fleur au fusil : c’est du grand
n’importe quoi. Cependant, partout la défense de la patrie l’emporte sur le pacifisme et sur
l’international socialiste. Chez tous les belligérants, il y a une explosion de patriotisme et un
consentement à la guerre. La «~fleur au fusil~» se fait surtout dans les capitales et en particulier
chez les jeunes universitaires qui sont les plus déconnectés de la réalité.

L’engouement est très minoritaire. La majorité est consternée mais déterminée à faire son
devoir envers la patrie. Tous ont le sentiment de défendre leur patrie, y compris les allemands
qui attaquent. Un imaginaire de guerre se met spontanément en place : la défense et la juste
cause contre les agresseurs de la patrie qui sont le mal incarné. En France, il existait un carnet
secret du gouvernement appelé le «~carnet B~». 2.000 personnes y avaient été préventivement
fichées. On prévoyait de les arrêter car ils risqueraient d’avoir un discours pacifiste. Au
moment de la mobilisation, au cours de l’été, le ministre de l’intérieur estime que c’est inutile.
Le ministre de l’intérieur voit que le consensus est réalisé. Au moment des funérailles de Jean
Jaurès, qui est en tête du cortège ? Des socialistes mais aussi l’archevêque de Paris, des
hommes de l’action française (extrême droite), etc. L’Union Sacrée est là et on ne doit arrêter
personne.

En Belgique c’est la même chose. Le 4 août le roi traverse Bruxelles à cheval et une foule
immense de gens est là pour l’accueillir. Au parlement, le roi est applaudit et on pleure
d’émotion. Les socialistes qui avaient chahuté lors du couronnement en 1909, applaudissent à
tout rompre. Les opinions publiques restent versatiles.

On comprend bien ce consentement mais comment ce consentement a-t-il duré ? Il y a
pourtant eu énormément de morts. Le taux de mort le plus haut est en 1914 : 20.000 mort en
une journée d’août pour les français. Comment l’opinion publique n’a-t-elle pas tout fait
arrêter à cette époque ?

\subsection{Le consentement à la guerre longue : le cas de la Belgique}

Ce consentement s’enracine dans les violences d’août 1914, notamment contre les civils.
Défendre la patrie contre le mauvais agresseur devient défendre la civilisation contre la
barbarie ontologique de l’ennemi. Le Boche est par essence mauvais. En 1915, l’évêque de
Londres dit : «~il faut les tuer tous, non pas par plaisir de tuer mais pour sauver l’humanité~».
Du côté allemand, c’est un combat de la culture contre ces barbares qui utilisent «~les sous-races~» (tirailleur sénégalais, maori, etc.). On entre dans une guerre pratiquement religieuse
avec une sacralisation morale de l’ennemi. Dire qu’il n’y avait pas de sens à la guerre c’est
une construction de l’après-guerre qui est fausse pour l’époque.

\subsection{Le viol de la neutralité et l'invasion}

S’il y a une seule armée au monde qui ne devait pas se battre c’était la Belgique. Elle n’a
aucune responsabilité dans cette guerre. Elle n’a rien à y gagner et elle y perdra d’ailleurs.
Elle avait tout fait pour essayer d’y échapper. Les Belges pensaient qu’on allait y échapper car
ce fut le cas en 1871. Le gouvernement belge ne partage pas la même analyse. Léopold~II
pense que c’est un miracle qu’on ait échappé à la guerre de 1871 et qu’il faut se renforcer. Sur
son lit de mort, il signe la loi de conscription d’un fils.

En 1911, il y a des tensions énormes relatives au Maroc. On croit vraiment que ça va être la
guerre. Les Allemands acceptent finalement de laisser le Maroc aux Français en échangent de
compensation en Afrique équatoriale. En Belgique on s’inquiète, le ministère de la guerre
reçoit des crédits, on mobilise trois sections de la Garde Nationale. À la suite d’accords en
novembre c’est le soulagement. La crise est passée. Londres a fait savoir qu’elle se rangeait
du coté de Paris et l’Allemagne a alors préférée trouver un accord. C’est intéressant à noter
car en 1914, les Britanniques ne sortent du bois que le 3 août. Le pays laisse ainsi croire à
l’Allemagne que peut être elle ne pourra pas rentrer en guerre.

Que se passe-t-il dans la tête des Belges avant l’année 1914 ? Léon Arendt analyse la
situation.
Les Belges savant que s’il y a un affrontement entre la France et l’Allemagne, la frontière
franco-allemande étant défendue, il faudra passer par la Belgique. La Belgique est le ventre
mou de la France. L’agression viendra vraisemblablement de l’Allemagne alors qu’on est plus
proche d’eux (économiquement, confessionnellement, etc.). On se dit que ça viendra des
Allemands car la France ne voudra pas fâcher la Grande-Bretagne. Deux scénarios germent
alors dans la tête des dirigeants belges :
